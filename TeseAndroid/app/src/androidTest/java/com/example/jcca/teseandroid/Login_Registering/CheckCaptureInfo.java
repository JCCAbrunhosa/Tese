...
public class CheckCaptureInfo {
    ...
    public void checkCaptureInfo() {
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView2.perform(scrollTo(), replaceText("joao.abrunhosa@ua.pt"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.goToGA), withText("Galeria de Avistamentos"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.info), withText("Info"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.guideList),
                                        0),
                                2),
                        isDisplayed()));
